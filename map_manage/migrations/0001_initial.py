    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('parentfacetid', models.IntegerField(blank=True, db_column='parentFacetID', null=True)),
                ('parentfacetname', models.CharField(blank=True, db_column='parentFacetName', max_length=255, null=True)),
                ('parentfacetlayer', models.IntegerField(blank=True, db_column='parentFacetLayer', null=True)),
                ('childfacetid', models.IntegerField(blank=True, db_column='childFacetID', null=True)),
                ('childfacetname', models.CharField(blank=True, db_column='childFacetName', max_length=255, null=True)),
                ('childfacetlayer', models.IntegerField(blank=True, db_column='childFacetLayer', null=True)),
                ('topicid', models.IntegerField(blank=True, db_column='topicID', null=True)),
            ],
            options={
